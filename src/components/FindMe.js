    ...
    return (
        <div>
            <div className="inline-flex gap-3 items-center">
                ...
                <HoverBorder link="https://www.linkedin.com/in/bmamatahir/">
                ...
                <HoverBorder link="https://github.com/bmamatahir">
                ...
                <a className="hover:underline hover:text-yellow-300 font-medium whitespace-nowrap"
                   href="mailto:b.mamatahir@gmail.com">Hire me</a>


                <a href={"/software-engineer.pdf"}
                   className={"whitespace-nowrap animated-border text-yellow-300 font-medium border-b-2 border-yellow-300"}>Download
                    CV</a>
            </div>
        </div>
    );
